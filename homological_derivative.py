"""Homological derivative transformer for computing successive distances between persistence diagrams."""
...
class HomologicalDerivative(PairwiseDistance):
    """Computes the successive distance between consecutive persistence diagrams.

    Extends PairwiseDistance to measure how much the topological signature of
    a time series changes from one sliding window to the next. Large values
    indicate rapid topological change, which can signal market stress or crashes.
    """
